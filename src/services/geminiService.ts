...
import type { JourneyData, Filters, Solution, LaunchPlaybook, Client, ManagedVendor, ChatMessage, MarketingCopy, PricingTier, ProfitabilityEstimates, SearchResult, SolutionStack, WebsiteTemplateContent, OnboardingCourseOutline, KnowledgeBaseArticle, IrresistibleOffer, IntegrationGuide, SystemAssetsPreview } from '../types/types';
import { filterOptionsData, categoryStructure, ALL_SOLUTIONS, CURATED_STACKS } from '../constants/constants';
